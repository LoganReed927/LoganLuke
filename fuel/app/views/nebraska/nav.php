<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?=Uri::create('index.php/nebraska/about'); ?>" target="_blank">About Us</a>
      </li>
    ...
    <div class="my-2 my-lg-0">
        ...
        <?php } else {?>
      <a class="btn btn-outline-danger my-2 my-sm-0" href="<?=Uri::create('index.php/nebraska/login'); ?>" target="_blank">Login</a>
        <?php } ?>
    </div>
  </div>
</nav>
